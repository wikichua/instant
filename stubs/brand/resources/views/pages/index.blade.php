@extends('{%brand_string%}::layouts.main')
@section('content')
<section class="mt-5 wow fadeIn">
  <h3 class="h3 text-center mb-5">About {%brand_name%}</h3>
  <!--Grid row-->
  <div class="row wow fadeIn">
    ...
    <div class="col-lg-6 col-md-12 px-4">
      ...
      <div class="row">
        ...
        <div class="col-10">
          <h5 class="feature-title">{%brand_name%}</h5>
          <p class="grey-text">Welcome to {%brand_name%}</p>
        </div>
      </div>
      <!--/First row-->
