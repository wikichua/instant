...
Route::group(['middleware' => ['web', 'auth_admin', 'can:access-admin-panel']], function () {
    Route::group(['prefix' => 'report'], function () {
        Route::match(['get', 'head'], '', [config('instant.Controllers.Report'),'index'])->name('report');
        Route::match(['get', 'head'], '{report}/read', [config('instant.Controllers.Report'),'show'])->name('report.show');
        Route::match(['post'], '{report}/export', [config('instant.Controllers.Report'),'export'])->name('report.export');
        Route::match(['get', 'head'], 'create', [config('instant.Controllers.Report'),'create'])->name('report.create');
        Route::match(['post'], 'create', [config('instant.Controllers.Report'),'store'])->name('report.store');
        Route::match(['get', 'head'], '{report}/edit', [config('instant.Controllers.Report'),'edit'])->name('report.edit');
