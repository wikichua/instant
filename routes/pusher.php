...
Route::group(['middleware' => ['web', 'auth_admin', 'can:access-admin-panel']], function () {
    Route::group(['prefix' => 'pusher'], function () {
        Route::match(['get', 'post'], '', [config('instant.Controllers.Pusher'),'index'])->name('pusher');
        Route::match(['get'], '{pusher}/read', [config('instant.Controllers.Pusher'),'show'])->name('pusher.show');
        Route::match(['get'], 'create', [config('instant.Controllers.Pusher'),'create'])->name('pusher.create');
        Route::match(['post'], 'create', [config('instant.Controllers.Pusher'),'store'])->name('pusher.store');
        Route::match(['get'], '{pusher}/edit', [config('instant.Controllers.Pusher'),'edit'])->name('pusher.edit');
