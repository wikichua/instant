<template>
    <div class="flex flex-col justify-center">
        <!-- Success -->
        <div class="flex items-center bg-green-500 border-l-4 border-green-700 py-2 px-3 shadow-md mb-2" v-if="$page.props.status == 'success'">
            <!-- icons -->
        ...
        <!-- Info -->
        <div class="flex items-center bg-blue-400 border-l-4 border-blue-700 py-2 px-3 shadow-md mb-2" v-if="$page.props.status == 'info'">
            <!-- icons -->
        ...
        <!-- Warning -->
        <div class="flex items-center bg-orange-400 border-l-4 border-orange-700 py-2 px-3 shadow-md mb-2" v-if="$page.props.status == 'warning'">
            <!-- icons -->
        ...
        <!-- Error -->
        <div class="flex items-center bg-red-500 border-l-4 border-red-700 py-2 px-3 shadow-md mb-2" v-if="$page.props.status == 'error' || hasErrors">
            <!-- icons -->
