        ...
        <instant-content-card>
            ...
            <instant-datatable :models="models" :columns="columns" :actionsComponent="InstantActions">
                <template #header-action-slot>
                    <instant-create-link :href="route('cronjob.create')" class="text-indigo-600 hover:text-indigo-900 inline-block" v-if="can.create" />
                </template>
            </instant-datatable>
...
<script>
    ...
    import InstantActions from '@/Pages/Admin/Cronjob/Actions'
    import InstantSearch from '@/Pages/Admin/Cronjob/Search'
