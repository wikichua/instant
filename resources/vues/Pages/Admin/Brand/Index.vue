<template>
    <authenticated-layout>
        <template #page-title>
            <inertia-link class="text-white text-sm uppercase hidden lg:inline-block font-semibold" :href="route('brand')">
...
<script>
    ...
    import InstantActions from '@/Pages/Admin/Brand/Actions'
    import InstantSearch from '@/Pages/Admin/Brand/Search'
