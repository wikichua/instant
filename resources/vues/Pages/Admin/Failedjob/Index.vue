<template>
    <authenticated-layout>
        <template #page-title>
            <inertia-link class="text-white text-sm uppercase hidden lg:inline-block font-semibold" :href="route('failedjob')">
...
<script>
    ...
    import InstantActions from '@/Pages/Admin/Failedjob/Actions'
    import InstantSearch from '@/Pages/Admin/Failedjob/Search'
